...
;;          (sub-exts '("srt" "sub"))
;;          (files (directory-files (dired-current-directory)))
...
;;         (let* ((tvdbid-season-lang (get-tvdbid-and-season-and-lang))
;;                (tvdbid (first tvdbid-season-lang))
;;                (season (second tvdbid-season-lang))
;;                (lang (third tvdbid-season-lang))
;;       (message "Number of subtitles does not match the number of episodes")
